...
public class PersonaDaoJDBC implements PersonaDAO{
    ...
    public List<PersonaDTO> seleccionar() throws SQLException{
        ...
        try { //para mantener una misma y unica conexion, por si se hace rollback
    ...
    public int actualizar(PersonaDTO persona) throws SQLException{ //int para indicar cuantos registros se han actualizado
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
    ...
    public int eliminar(PersonaDTO persona) throws SQLException{ //int para indicar cuantos registros se han actualizado
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
