...
public class UsuarioDAO {
    ...
    public int actualizar(Usuario usuario) throws SQLException{ //int para indicar cuantos registros se han actualizado
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
    ...
    public int eliminar(Usuario usuario) throws SQLException{ //int para indicar cuantos registros se han actualizado
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
