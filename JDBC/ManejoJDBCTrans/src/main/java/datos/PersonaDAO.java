...
public class PersonaDAO {
    ...
    public int actualizar(Persona persona) throws SQLException{ //int para indicar cuantos registros se han actualizado
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
    ...
    public int eliminar(Persona persona) throws SQLException{ //int para indicar cuantos registros se han actualizado
        Connection conn = null;
        PreparedStatement stmt = null;
        int registros = 0;
        try {
